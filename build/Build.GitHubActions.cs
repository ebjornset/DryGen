...
[DotNetGitHubActions(name: "tag-version", OnWorkflowDispatchRequiredInputs = new[] { "version" }, InvokedTargets = new[] { nameof(CiCd_TagVersion) }, PublishArtifacts = true, ImportSecrets = new[] { nameof(SonarToken) }, WritePermissions = new[] { GitHubActionsPermissions.Contents })]
