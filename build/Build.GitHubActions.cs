...
[DotNetGitHubActions(name: "tag-version", AutoGenerate = false, OnWorkflowDispatchRequiredInputs = ["version"], InvokedTargets = [nameof(CiCd_TagVersion)], PublishArtifacts = false, ImportSecrets = [nameof(SonarToken)], WritePermissions = [GitHubActionsPermissions.Contents, GitHubActionsPermissions.Actions])]
