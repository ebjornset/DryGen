...
[GhPagesGitHubActions(name: "publish-docs", On = new[] { GitHubActionsTrigger.WorkflowDispatch }, InvokedTargets = new[] { nameof(CiCd_BuildDocs) }, PublishArtifacts = false, WritePermissions = new[] { GitHubActionsPermissions.IdToken, GitHubActionsPermissions.Pages })]
