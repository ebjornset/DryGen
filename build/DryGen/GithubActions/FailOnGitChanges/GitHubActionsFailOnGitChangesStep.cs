        ...
        public override void Write(CustomFileWriter writer)
        {
            ...
            using (writer.Indent())
            {
                ...
                using (writer.Indent())
                {
                    ...
                    using (writer.Indent())
                    {
                        writer.WriteLine($"core.setFailed('Git modifications found after [nuke]. Maybe [nuke docs] was omitted before commit? Check the output from the step \"{GitHubActionsListGitChangesStep.StepName}\" for details about the git changes.')");
                    }
                }
            }
        }
